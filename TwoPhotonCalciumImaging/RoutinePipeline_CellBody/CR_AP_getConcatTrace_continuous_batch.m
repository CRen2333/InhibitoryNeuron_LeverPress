function [roi_trace,roi_trace_bg] = CR_AP_getConcatTrace_continuous_batch(roi_filename,tiff_path,interp_sub,local_comp,bouton_on)
...
if bouton_on % bouton, the first one is alway background
    roi_trace_bg = roi_trace(end,:);
    roi_trace = roi_trace(1:end-1,:);
end
