...
switch SessionType
    case 'Nai_Ant'
        Animals = {'CR_3702608-O','CR_3702608-LR','CR_3658844-L','CR_3658844-R','CR_3658845-R','CR_3672031-O','CR_3887044-O','CR_3887044-L','CR_3786160-LR','CR_3887043-O','CR_3887043-L','CR_3887041-O'};
    case 'Exp_Ago'
...
switch SessionType
    case 'Nai_Ant'
        ...
        SessionTages = zeros(length(Animals),2);
    case 'Exp_Ago'
        Animals = {'WL_3526642-L','WL_3526642-R','CR_3619106-R','CR_3619106-LR','CR_3633192-L','CR_3633192-R','CR_3702608-O','CR_3702608-LR','CR_3658844-R','CR_3672031-O','CR_3633193-L'};           
        Drug = 'Ago';
...
%     SessionTages(curr_animal,:) = cellfun(@(x) contains(x, Drug), SessionTage);
...
set(h(2),'EdgeColor','none','FaceColor',color_value(4,:),'FaceAlpha',0.3);
plot(temp_1,'color',color_value(4,:),'linewidth',2);
line([8,8],ylim,'color','k','linestyle',':','linewidth',1); ylim([-0.35, 0.05]);
xlim([1,36]); xticks([8,22,36]); xticklabels({'0','1','2'}); xlabel('Time (sec)');
