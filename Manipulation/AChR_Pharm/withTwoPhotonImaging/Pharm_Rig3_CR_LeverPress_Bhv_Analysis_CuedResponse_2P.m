...
for curr_animal = 1:length(Animals)
    ...
    General_path = ['Z:\People\Chi\TwoP_IN\' IN filesep Animal filesep 'Pharm\' SessionType];
    cd(General_path);
    mkdir('MovAnalysis');
...
%             CuedMov.Bpod{curr_session} = TrialInfo_Bpod{curr_session};
    ...
    % Save
    cd(['Z:\People\Chi\TwoP_IN\' IN filesep Animal filesep 'Pharm\' SessionType filesep 'MovAnalysis']);
