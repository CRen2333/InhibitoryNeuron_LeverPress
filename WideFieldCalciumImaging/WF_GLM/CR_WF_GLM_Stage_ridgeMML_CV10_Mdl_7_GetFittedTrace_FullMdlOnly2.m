...
for curr_IN = 1:length(INs)
    ...
    for curr_animal = 1:length(Animals)
        ...
        if FullOnly
            file_name = [data_folder filesep IN '_' Initial '_' Animal '_df_f_all_pseudoICA_GLM_stage_ridgeMML_CV10_FullOnly.mat'];
        else
        ...
        load([data_folder filesep IN '_' Initial '_' Animal '_df_f_all_pseudoICA_GLM_stage_ridgeMML_CV10.mat'],'predictors_all');
        ...
        savefile_name = [data_folder filesep IN '_' Initial '_' Animal '_df_f_all_pseudoICA_GLM_stage_ridgeMML_CV10_FullBetaOnly2.mat'];
