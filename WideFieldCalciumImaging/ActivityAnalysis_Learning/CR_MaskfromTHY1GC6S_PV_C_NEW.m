...
hold on;
bar(position.Naive,nanmean(Cued_subtract_postActivity_all.Naive_AVE(:,reordered_module)),0.20,'FaceColor',CX(4,:),'LineStyle','none')
bar(position.Early,nanmean(Cued_subtract_postActivity_all.Early_AVE(:,reordered_module)),0.20,'FaceColor',CX(3,:),'LineStyle','none')
bar(position.Middle,nanmean(Cued_subtract_postActivity_all.Middle_AVE(:,reordered_module)),0.20,'FaceColor',CX(2,:),'LineStyle','none')
bar(position.Late,nanmean(Cued_subtract_postActivity_all.Late_AVE(:,reordered_module)),0.20,'FaceColor',CX(1,:),'LineStyle','none')
for curr_ROI = 1:length(ROI)
    line([position.Naive(curr_ROI),position.Naive(curr_ROI)],[(nanmean(Cued_subtract_postActivity_all.Naive_AVE(:,reordered_module(curr_ROI)))-(nanstd(Cued_subtract_postActivity_all.Naive_AVE(:,reordered_module(curr_ROI)))./(sum(~isnan(Cued_subtract_postActivity_all.Naive_AVE(:,1)))^0.5))),...
        (nanmean(Cued_subtract_postActivity_all.Naive_AVE(:,reordered_module(curr_ROI)))+(nanstd(Cued_subtract_postActivity_all.Naive_AVE(:,reordered_module(curr_ROI)))./(sum(~isnan(Cued_subtract_postActivity_all.Naive_AVE(:,1)))^0.5)))],'Color',CX(4,:),'LineWidth',1);
    line([position.Early(curr_ROI),position.Early(curr_ROI)],[(nanmean(Cued_subtract_postActivity_all.Early_AVE(:,reordered_module(curr_ROI)))-(nanstd(Cued_subtract_postActivity_all.Early_AVE(:,reordered_module(curr_ROI)))./(sum(~isnan(Cued_subtract_postActivity_all.Early_AVE(:,1)))^0.5))),...
        (nanmean(Cued_subtract_postActivity_all.Early_AVE(:,reordered_module(curr_ROI)))+(nanstd(Cued_subtract_postActivity_all.Early_AVE(:,reordered_module(curr_ROI)))./(sum(~isnan(Cued_subtract_postActivity_all.Early_AVE(:,1)))^0.5)))],'Color',CX(3,:),'LineWidth',1);
    line([position.Middle(curr_ROI),position.Middle(curr_ROI)],[(nanmean(Cued_subtract_postActivity_all.Middle_AVE(:,reordered_module(curr_ROI)))-(nanstd(Cued_subtract_postActivity_all.Middle_AVE(:,reordered_module(curr_ROI)))./(sum(~isnan(Cued_subtract_postActivity_all.Middle_AVE(:,1)))^0.5))),...
        (nanmean(Cued_subtract_postActivity_all.Middle_AVE(:,reordered_module(curr_ROI)))+(nanstd(Cued_subtract_postActivity_all.Middle_AVE(:,reordered_module(curr_ROI)))./(sum(~isnan(Cued_subtract_postActivity_all.Middle_AVE(:,1)))^0.5)))],'Color',CX(2,:),'LineWidth',1);
    line([position.Late(curr_ROI),position.Late(curr_ROI)],[(nanmean(Cued_subtract_postActivity_all.Late_AVE(:,reordered_module(curr_ROI)))-(nanstd(Cued_subtract_postActivity_all.Late_AVE(:,reordered_module(curr_ROI)))./(sum(~isnan(Cued_subtract_postActivity_all.Late_AVE(:,1)))^0.5))),...
        (nanmean(Cued_subtract_postActivity_all.Late_AVE(:,reordered_module(curr_ROI)))+(nanstd(Cued_subtract_postActivity_all.Late_AVE(:,reordered_module(curr_ROI)))./(sum(~isnan(Cued_subtract_postActivity_all.Late_AVE(:,1)))^0.5)))],'Color',CX(1,:),'LineWidth',1);
end
...
% Get averaged trace from 4 stages
...
fields = {'Naive','Early','Middle','Late'};
colorvalue = [CX(4,:); CX(3,:); CX(2,:); CX(1,:)];
...
for curr_ROI = 1:length(ROI)
    ...
    xlim([1 76]); ylim([-0.005, 0.03]); ylabel('df/f'); xlabel('Time (sec)');
...
xlim([1 76]); ylim([-0.004, 0.026]); ylabel('df/f'); xlabel('Time from mvm. onset (sec)');
set(gca,'XTick',[16,46,76],'XTickLabel',{'0','1','2'});
