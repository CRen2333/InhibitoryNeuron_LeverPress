...
Im_str=mmread([PathName '\' FileName]);
[images_big]=Im_str(fr);
moviee=mmread('tulip5.avi');
...
%% LID DIAMETER
figure;imagesc(CROPPED(:,:,1));axis image;colormap('gray')
[EYE_OP]=CM_CROP_MOVIE(CROPPED);
[Threshold_lid] = thresh_tool(CROPPED(:,:,1),'gray');
