...
% only read single recording [HL 2016/1/12]
% modify by HL to read ephus recordings in mom scope using HL_lever setting
% files

function data = MomEphus_load_xsg_continuous(dirname)
    if(nargin==0)
