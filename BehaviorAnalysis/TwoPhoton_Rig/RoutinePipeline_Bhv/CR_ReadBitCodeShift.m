%% The purpose of this coding is to correct bitcode shift caused by certain bad linux machine
%% Used for the following xsg files, the shited time point value was calculated by the first xsg file

function [TrialNumber] = CR_ReadBitCodeShift(xsg, shiftTimePoint)
