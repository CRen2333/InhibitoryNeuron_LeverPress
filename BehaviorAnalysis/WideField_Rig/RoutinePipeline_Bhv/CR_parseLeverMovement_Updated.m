function [lever_active lever_force_resample lever_force_smooth ...
    lever_velocity_envelope_smooth] = CR_parseLeverMovement_Updated(xsg_data, gap_allowance, movement_leeway, active_threshold)
...
disp(['active_threshold: ' num2str(active_threshold)]);
...
movethresh = 0.0007;
lever_active = lever_velocity_envelope_smooth > movethresh*active_threshold;
